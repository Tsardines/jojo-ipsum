...
let resultsBox = document.getElementsByClassName("results-box");

myObj.forEach(function(item) {
    let myItem = document.createAttribute("div");

    myItem.innerHTML = element.myItem;

    resultsBox.appendChild(myItem);
})